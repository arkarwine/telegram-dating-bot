MESSAGES = {
    "en": {
        ...
        "chat_opened": "💬 Private chat with {name} is open.\n\nJust message normally. Everything you send here goes to this match until you exit or switch chats. Message contents are relayed through Telegram and are not stored in the bot database.",
        "chat_closed": "Private chat closed.",
        "chat_incoming": "💬 New private message from {name}",
        "chat_session_started_remote": "🟢 {name} opened your private match chat.",
        "chat_session_ended_remote": "⚪ {name} left your private match chat.",
    ...
    "my": {
        ...
        "chat_opened": "💬 {name} နဲ့ private chat ဖွင့်ထားပါတယ်။\n\nပုံမှန် message ပို့ပါ။ Exit သို့မဟုတ် chat ပြောင်းတဲ့အထိ ဒီ match ဆီ ပို့ပေးပါမယ်။ Message content ကို bot database မှာ မသိမ်းပါ။",
        "chat_closed": "Private chat ပိတ်ပြီးပါပြီ။",
        "chat_incoming": "💬 {name} ဆီက private message အသစ်",
        "chat_session_started_remote": "🟢 {name} က သင်တို့ private match chat ကို ဖွင့်လိုက်ပါတယ်။",
        "chat_session_ended_remote": "⚪ {name} က သင်တို့ private match chat ကနေ ထွက်သွားပါပြီ။",
